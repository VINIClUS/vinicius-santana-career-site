...
<header><h1>SO-07 visual kit</h1><p>Development-only inspection. All posters below work without JavaScript or WebGL. Models load only when requested.</p><p>${allPosters.length} responsive poster pairs · ${sceneAssets.length} independent models</p></header>
